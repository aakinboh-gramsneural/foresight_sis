                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="padding-bottom: 28px;">
                                        <p style="margin-top: 0; margin-bottom: 0; color: #1d3a6b; font-size: 15px; line-height: 26px;">
                                            Thank you for contacting Foresight Corporate Governance Consulting. We have received your message and a member of our team will review it shortly.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-bottom: 20px;">
                                        <p style="margin-top: 0; margin-bottom: 0; color: #6c80a4; font-size: 11px; letter-spacing: 1.5px; font-weight: bold;">
                                            ...
                                            <tr>
                                                <td style="background-color: #f8f9fb; padding-top: 20px; padding-bottom: 20px; padding-left: 24px; padding-right: 24px;">
                                                    @if($submission->subject)
                                                        <p style="margin-top: 0; margin-bottom: 12px; color: #0a1628; font-size: 13px; font-weight: bold;">
                                ...
                                <tr>
                                    <td style="padding-bottom: 32px;">
                                        <p style="margin-top: 0; margin-bottom: 0; color: #6c80a4; font-size: 14px; line-height: 22px;">
                                            We typically respond within 1&ndash;2 business days. If your matter is urgent, please call us at <strong style="color: #0a1628;">4036671396</strong>.
                                        </p>
                                    </td>
                                </tr>
                            </table>
